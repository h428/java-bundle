...
//    public static <T> PageBean<T> fromJsonToPageBean(String json, Class<T> entityClass) {
//        if (json == null) {
//            return null;
//        }
//
...
//        } catch (IOException e) {
//            logger.error("从 json 反序列化为 pageBean 时发生异常 :", e);
//            throw new RuntimeException(e);
//        }
//    }
    ...
    public static <T> List<T> fromJsonToList(String json, Class<T> entityClass) {
        ...
        try {
            ...
            logger.error("从 json 反序列化为 listPage 时发生异常 :", e);
            throw new RuntimeException(e);
        }
    }
