...
public class BaseWebTest extends BaseTest {
    ...
    protected static String catToken;
    ...
    public void setUp() {
        ...
        catToken = TokenUtil.generateTokenOfBaseUser(1L);
    }
     ...
     * @return 封装的 Request
     */
    protected RequestChain get(String url, Object... vars) {
        return new RequestChain(HttpMethod.GET, url, vars);
    }
     ...
     * @return 封装的 Request
     */
    protected RequestChain post(String url, Object... vars) {
        return new RequestChain(HttpMethod.POST, url, vars);
    }
     ...
     * @return 封装的 Request
     */
    protected RequestChain put(String url, Object... vars) {
        return new RequestChain(HttpMethod.PUT, url, vars);
    }
     ...
     * @return 封装的 Request
     */
    protected RequestChain delete(String url, Object... vars) {
        return new RequestChain(HttpMethod.DELETE, url, vars);
    }
    ...
    public class RequestChain {
         ...
         * @param vars 路径参数
         */
        public RequestChain(HttpMethod method, String url, Object... vars) {
         ...
         */
        public RequestChain header(String headerName, String headerValue) {
            // 设置请求头
         ...
         * @return 返回 Request 以链式调用
         */
        public RequestChain token(String token) {
            // 设置请求头
         ...
         * @return 返回 Request 以链式调用
         */
        public RequestChain baseUser(String baseUserId) {
            // 设置请求头
         ...
         * @return 返回 Request 以链式调用
         */
        public RequestChain body(Object body) {
            // 请求体转化为 json
         ...
         * @return 返回 Request 以链式调用
         */
        public RequestChain param(String paramName, String paramValue) {
         ...
         * @return 返回 Request 以链式调用
         */
        public RequestChain param(Object object) {
            Map<String, Object> properties = ClassUtil.objectToMap(object);
    ...
    public static class Response {
         ...
         * @return 返回 Result 以便能够链式校验
         */
        public Response propertyEquals(String propertyName, Object expectedValue) {
            try {
